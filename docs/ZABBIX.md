...
Schwesterprojekten Sensormeter (WT32-ETH01) und Sensormeter PoE ab (dort
zusätzlich `.2.1.0`=LAN-IP und ein kompletter `.4.x`-Sensor-2-Zweig).
Dieses Template ist bereits auf dieses Schema abgestimmt – bei
